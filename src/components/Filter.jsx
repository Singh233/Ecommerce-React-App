  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.options}>
        ...
        <div
          className={`animate__animated animate__faster ${styles.sortOptions} ${
            showOptions ? styles.hide : "animate__zoomIn"
          }`}
        >
          <p
          ...
          >
            <FontAwesomeIcon icon={faDiceD6} /> Latest <span>Default</span>{" "}
          </p>
          <div className={styles.border}></div>
          <p
            style={lowToHighActive ? activeTextEffect : {}}
            onClick={handleLowToHighClick}
            className={styles.lowHigh}
          >
            {" "}
            <FontAwesomeIcon icon={faArrowUp} /> Low to High
          </p>
          <div className={styles.border}></div>
          <p
          ...
          >
            {" "}
            <FontAwesomeIcon icon={faArrowDown} /> High to Low
          </p>
        </div>
      </div>
    </div>
